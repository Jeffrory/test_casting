typealias RegistrarEntry<T> = Particle_CastingRegistrar<T>.Entry<out T>

abstract class Particle_CastingRegistrar<T : Any>(
    ...
    fun <V : T> register(name: String, builder: () -> V): Entry<V> = register(Particle_Casting.castingparticles, builder)
    ...
    open inner class Entry<V : T>(
        ...
        override fun equals(other: Any?) = when (other) {
            is Particle_castingRegistrar<*>.Entry<*> -> key.registry().equals(other.key.registry()) && id.equals(other.id)
            else -> false
        }
